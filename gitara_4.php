...
<div class="page-title fix"><!--Start Title-->
	<div class="overlay section">
		<h2>Бас гітара</h2>
									...
									<?php
									$products = mysqli_query($link, "SELECT * FROM `guitar` WHERE id_vid=4");
				...
				<div class="shop-sidebar fix">
					...
					<h2>Рівень гітари</h2>
						<ul>
							...
							<li><a class="activer_7" values = "nachalo_4"> Для початковців</a></li>
							<li><a class="activer_7" values = "prakt_4"> Для практикуючих</a></li>
							<li><a class="activer_7" values = "concert_4"> Для концертів</a></li>
						</ul>
					</div>
					<!-- single-sidebar end -->
					<!-- single-sidebar start -->
					...
					<h2>Фірма</h2>
						<ul>
						<li>	<a  class="activer_8" values = "ya_4" >Yamaha</a></li>
							<li><a  class="activer_8" values = "gib_4">Gibson</a></li>
							<li><a  class="activer_8" values = "ibanez_4">IBANEZ</a></li>
							<li><a  class="activer_8" values = "es_4">ESP</a></li>
							<li><a  class="activer_8" values = "fen_4">Fender</a></li>
						</ul>
					</div>
					<!-- single-sidebar end -->
				...
				<div class="row">
					...
					<div class="sort-by">
						...
						<span> Сортування гітар по: </span>
							<select name="sort-by" class= "sortirvka_3">
						...
						<div class="show-product">
							...
							<select class="activer_4_1">
								<option  value="all_s">Усі</option>
								<option  value="4_s"  >4  </option>
								<option  value="5_s"  >5  </option>
					...
					<?php
										...
										$quary = "SELECT * FROM `guitar` WHERE id_vid=4 LIMIT $from, $notesOnPage";
							...
							echo '</div>';
									...
									$quary = "SELECT COUNT(*) as count FROM `guitar` WHERE id_vid=4";
									$table = mysqli_query($link, $quary);
