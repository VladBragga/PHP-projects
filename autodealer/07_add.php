		...
		<div id="content">
			<div class="content">
				<div class="breadcrumbs">
					...
					<span>Додавання автомобілю</span>
				</div>
					
					
			<form action="php/cars/add_car.php" enctype="multipart/form-data" method="post">
				<div class="main_wrapper">
					<div class="sell_box sell_box_1">
						<h2><strong>Додавання</strong> нового автомобіля</h2>
						<?
						...
						if($_SESSION['error_input']){?>
							<div class="error_message">
								<p><?=$_SESSION['error_input']?></p>
							</div>
						...
						<div class="input_wrapper">
							...
							<div class="input_model">
								<input type="text" class="txb" name="name" value="" required/>
							</div>
						</div>
						<div class="select_wrapper">
					...
					<div class="sell_box sell_box_3">
						...
						<div class="select_wrapper" style="margin-left: 120px;">
							...
							<input type="number" class="txb" name="price" value="0.00" required/>
						</div>
						<div class="input_wrapper">
							<label style="margin-right: 35px;"><span>* </span><strong>З салону: </strong></label>
							<input type="text" class="txb" name="link_of" required placeholder="Всавте посилання"/>
						</div>
						<div class="input_wrapper">
							<label style="margin-right: 35px;"><span>* </span><strong>Неофіційний поставщик </strong></label>
							<input type="text" name="link_no" class="txb" required placeholder="Всавте посилання"/>
						</div>
						<div class="clear"></div>
					</div>
					<div class="sell_box sell_box_4">
						...
						<div class="foto_wrapper" style="margin-left: 70px;">
                            ...
                            <label class="custom-file-upload">
                                <input id="fl_inp1" name="photo1" type="file" required/>
						...
						<div class="foto_wrapper">
							<a>
                            <label class="custom-file-upload">
                                <input id="fl_inp2" name="photo2" type="file" required/>
                                <img src="images/upload.png" alt="" class="upload"/> Вставити фото
                            </label>
							</a>
						...
						<div class="foto_wrapper">
							<a>
                            <label class="custom-file-upload">
                                <input id="fl_inp3" name="photo3" type="file" required/>
                                <img src="images/upload.png" alt="" class="upload"/> Вставити фото
                            </label>
							</a>
						...
						<div class="foto_wrapper">
							<a>
                            <label class="custom-file-upload">
                                <input id="fl_inp4" name="photo4" type="file" required/>
                                <img src="images/upload.png" alt="" class="upload"/> Вставити фото
                            </label>
							</a>
						...
						<div class="foto_wrapper last">
                            ...
                            <label class="custom-file-upload">
                                ...
                                <img src="images/upload.png" alt="" class="upload" required/> Вставити фото
                            </label>
							</a>
					...
					<div class="sell_box sell_box_5">
						...
						<div class="input_wrapper">
							<textarea type="text" name="opis" placeholder="Опишіть машину детальніше..." class="txb" style="min-width: 920px; min-height: 150px;" required></textarea>
						</div>
					...
					<div class="sell_submit_wrapper">
						...
						<input type="submit" value="Додати" class="sell_submit"/>
						<div class="clear"></div>
					</div>
				</div>
			  </form>
