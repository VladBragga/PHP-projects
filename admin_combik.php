	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 col-lg-3">
				...
				<p><span class="lang2">Вихід з таблиці combo</span></p>
		...
		<div class="row">
			<div class="clo-md-12">
				<div class="main-menu hidden-sm hidden-xs" boarder="1px solid red" padding=" 10px">
					<nav>
						<ul>
							<li><h3><span class="lang2">ТАБЛИЦЯ COMBO</span></h3>
							</li>
						</ul>
					</nav>
				</div>
...
<div >
<a style="margin:450px" href="admin_c_add.php" >Додавання нового комбіку</a>
 </div>
<table>
<tr>
<th>	Назва комбопідсилювача 		</th>
<th>	Країна		</th>
<th>Переглянути			</th>
<th>	Видалити			</th>
</tr>
<?php   foreach($combik as $comb)
	{ ?>
	<tr>
	<td><?=$comb['c_name']?></td>
	<td><?=$comb['c_country']?></td>
	
	<td><a href="details_c.php?id=<?=$comb['c_id']?>">Переглянути</a></td>
	<td><a href="admin_c_del.php?id=<?=$comb['c_id']?>">Видалити</a></td>
	</tr>
	<?php } ?>
 </table>
 <?php
