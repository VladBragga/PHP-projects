...
<div class="page-title fix"><!--Start Title-->
	<div class="overlay section">
		<h2>Комбопідсилювачі для басу</h2>
	</div>
</div><!--End Title-->
			...
			<div class="col-md-3">
				<div class="shop-sidebar fix">
					...
					<h2>Рівень комбіку</h2>
						<ul>
						<li><a class="activer_c5" values = "nachalo"> Для початковців</a></li>
							<li><a class="activer_c5" values = "prakt"> Для практикуючих</a></li>
							<li><a class="activer_c5" values = "concert"> Для концертів</a></li>
					...
					<h2>Фірма</h2>
						<ul>
						<li><a 	class="activer_c6" values = "ya"  >Yamaha</a></li>
							<li><a  class="activer_c6" values = "lan" >Laney</a></li>
							<li><a  class="activer_c6" values = "cor" >Cort </a></li>
							<li><a  class="activer_c6" values = "ibanez">IBANEZ</a></li>
							<li><a  class="activer_c6" values = "mar">Marshall</a></li>
							<li><a  class="activer_c6" values = "fen">Fender</a></li>					
						</ul>
					</div>
					<!-- single-sidebar end -->
				</div>
			...
			<div class="col-md-9">
				<div class="row">
					<div class="shop-tool-bar col-sm-12 fix">
						...
						<?php
									$products = mysqli_query($link, "SELECT * FROM `combo` WHERE id_vid=4");
						...
						<span>Сортування гітар по: </span>
							<select name="sort-by" class= "sortirvka_6">
						...
						<div class="show-product">
							...
							<select  name="sort-by" class = "act_c3">
					...
					<?php
									...
									$quary = "SELECT * FROM `combo` WHERE id_vid=4 LIMIT $from, $notesOnPage";
						...
						<?php
										...
										echo '</div>';
										$quary = "SELECT COUNT(*) as count FROM `combo` WHERE id_vid=4";
										$table = mysqli_query($link, $quary);
