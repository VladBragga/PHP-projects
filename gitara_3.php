		...
		<div class="row">
			<div class="col-md-3">
				<div class="shop-sidebar fix">
					...
					<h2>Рівень гітари</h2>
						<ul>
						<li><a 	   class="activer_3" values = "child_3"> Для дітей</a></li>
							<li><a class="activer_3" values = "nachalo_3"> Для початковців</a></li>
							<li><a class="activer_3" values = "prakt_3"> Для практикуючих</a></li>
							<li><a class="activer_3" values = "concert_3"> Для концертів</a></li>
						</ul>
					</div>
					<!-- single-sidebar end -->
					<!-- single-sidebar start -->
					...
					<h2>Фірма</h2>
						<ul>
						<li><a 		class="activer_4" values = "ya" >Yamaha</a></li>
							<li><a  class="activer_4" values = "cor">Cort</a></li>
							<li><a  class="activer_4" values = "ibanez">IBANEZ</a></li>
							<li><a  class="activer_4" values = "fen">Fender</a></li>
							<li><a  class="activer_4" values = "el">Enrique Keller S.A.</a></li>
						</ul>
					</div>
					<!-- single-sidebar end -->
				</div>
			...
			<div class="col-md-9">
				<div class="row">
					<div class="shop-tool-bar col-sm-12 fix">
						<div class="sort-by">
						<?php
									$products = mysqli_query($link, "SELECT * FROM `guitar` WHERE id_vid=1");
							...
							<select name="sort-by" class= "sortirvka_2">
					...
					<?php
										...
										$quary = "SELECT * FROM `guitar` WHERE id_vid=1 LIMIT $from, $notesOnPage";
									...
									echo '</div>';
									$quary = "SELECT COUNT(*) as count FROM `guitar` WHERE id_vid=1";
									$table = mysqli_query($link, $quary);
