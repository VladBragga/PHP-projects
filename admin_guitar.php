	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 col-lg-3">
				...
				<p><span class="lang2">Вихід з таблиці guitar</span></p>
		...
		<div class="row">
			<div class="clo-md-12">
				<div class="main-menu hidden-sm hidden-xs" boarder="1px solid red" padding=" 10px">
					<nav>
						<ul>
							<li><h3><span class="lang2">ТАБЛИЦЯ GUITAR</span></h3>
							</li>
						</ul>
					</nav>
				</div>
...
<div >
<a style="margin:450px" href="admin_g_add.php" >Додавання нової гітари</a>
 </div>
<table>
<tr>
<th>	Назва гітари  		</th>
...
<?php   foreach($gitars as $gitar)
	...
	<tr>
	<td><?=$gitar['g_name']?></td>
	<td><?=$gitar['g_country']?></td>
	<td><a href="details_g.php?id=<?=$gitar['g_id']?>">Переглянути</a></td>
	<td><a href="admin_g_del.php?id=<?=$gitar['g_id']?>">Видалити</a></td>
	</tr>
	<?php } ?>
 </table>
 <?php
