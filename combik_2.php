...
<div class="page-title fix"><!--Start Title-->
	<div class="overlay section">
		<h2>Комбопідсилювачі для електрогітари</h2>
	</div>
</div><!--End Title-->
			...
			<div class="col-md-3">
				<div class="shop-sidebar fix">
					...
					<h2>Рівень комбіку</h2>
						<ul>
						    <li><a class="activ_co3" values = "nachalo"> Для початковців</a></li>
							<li><a class="activ_co3" values = "prakt"> Для практикуючих</a></li>
							<li><a class="activ_co3" values = "concert"> Для концертів</a></li>
					...
					<h2>Фірма</h2>
						<ul>
						    <li><a 	class="activer_c4" values = "ya"  >Yamaha</a></li>
							<li><a  class="activer_c4" values = "lan" >Laney</a></li>
							<li><a  class="activer_c4" values = "cor" >Cort </a></li>
							<li><a  class="activer_c4" values = "ibanez">IBANEZ</a></li>
							<li><a  class="activer_c4" values = "mar">Marshall</a></li>
							<li><a  class="activer_c4" values = "fen">Fender</a></li>				
						</ul>
					</div>
				</div>
			</div>
			<div class="col-md-9">
				<div class="row">
					<div class="shop-tool-bar col-sm-12 fix">
						...
						<?php
									$products = mysqli_query($link, "SELECT * FROM `combo` WHERE id_vid=3");
						...
						<span>Сортування гітар по: </span>
							<select name="sort-by" class= "sortirvka_5">
						...
						<div class="show-product">
							...
							<select  name="sort-by" class = "act_c2">
					...
					<?php
									...
									$quary = "SELECT * FROM `combo` WHERE id_vid=3 LIMIT $from, $notesOnPage";
									...
									echo '</div>';
									$quary = "SELECT COUNT(*) as count FROM `combo` WHERE id_vid=3";
									$table = mysqli_query($link, $quary);
