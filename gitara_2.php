...
<?php
									$products = mysqli_query($link, "SELECT * FROM `guitar` WHERE id_vid=3");
		...
		<div class="row">
			<div class="col-md-3">
				<div class="shop-sidebar fix">
					...
					<h2>Рівень гітари</h2>
						<ul>
							<li><a class="activer_5" values = "nachalo"> Для початковців</a></li>
							<li><a class="activer_5" values = "prakt"> Для практикуючих</a></li>
							<li><a class="activer_5" values = "concert"> Для концертів</a></li>
					...
					<h2>Фірма</h2>
						<ul>
						<li>	<a class="activer_6" values = "ya" >Yamaha</a></li>
							<li><a  class="activer_6" values = "gib">Gibson</a></li>
							<li><a  class="activer_6" values = "cor">Cort</a></li>
							<li><a  class="activer_6" values = "ibanez">IBANEZ</a></li>
							<li><a  class="activer_6" values = "fen">Fender</a></li>
				...
				<div class="row">
					<div class="shop-tool-bar col-sm-12 fix">
						...
						<span>Сортування гітар по: </span>
							<select name="sort-by" class= "sortirvka_1">
					...
					<?php
										...
										$quary = "SELECT * FROM `guitar` WHERE id_vid=3 LIMIT $from, $notesOnPage";
									...
									echo '</div>';
									$quary = "SELECT COUNT(*) as count FROM `guitar` WHERE id_vid=3";
									$table = mysqli_query($link, $quary);
