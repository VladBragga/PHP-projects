...
<div class="page-title fix"><!--Start Title-->
	<div class="overlay section" >
		<h2>Акустична гітара</h2>
	</div>
</div><!--End Title-->
									<?php
									$products = mysqli_query($link, "SELECT * FROM `guitar` WHERE id_vid=2");
		...
		<div class="row">
			<div class="col-md-3">
				<div class="shop-sidebar fix">
					...
					<div class="sin-shop-sidebar guitar-category">
						<h2>Рівень гітари</h2>
						<ul>
							<li><a class="activer" values = "nachalo"> Для початковців</a></li>
							<li><a class="activer" values = "prakt"> Для практикуючих</a></li>
							<li><a class="activer" values = "concert"> Для концертів</a></li>
					...
					<!-- single-sidebar end -->
					<!-- single-sidebar start -->
					<div class="sin-shop-sidebar guitar_firm">
					<h2>Фірма</h2>
						<ul>
							<li><a class="activer_2" values = "ya" >Yamaha</a></li>
							<li><a  class="activer_2" values = "mar" >The Martin Guitar Company</a></li>
							<li><a  class="activer_2" values = "gib">Gibson</a></li>
							<li><a  class="activer_2" values = "cor">Cort</a></li>
							<li><a  class="activer_2" values = "ibanez">IBANEZ</a></li>
						    <li><a  class="activer_2" values = "fen">Fender</a></li>
				...
				<div class="row">
					<div class="shop-tool-bar col-sm-12 fix">
						...
						<span>Сортування гітар по: </span>
							<select name="sort-by" class= "sortirvka">
						...
						<div class="show-product">
							<span>Кількість струн:</span>
							<select  class="activer_2_1">
								<option  value="all_s">Усі</option>
								<option  value="6_s">6</option>
								<option  value="12_s">12</option>
						...
						<?php	
						if($kol==1 )
						echo '<span> В каталозі ' .$kol. ' гітара</span>';
						if($kol==2 ||  $kol==3 || $kol==4)
						echo '<span> В каталозі ' .$kol. ' гітари</span>';
						if($kol>4)
						
						echo '<span> В каталозі ' .$kol. ' гітар</span>';
							?>
						</div>
					</div>
						<div class = "git">
					<div class="shop-products">
								...
								<?php
										...
										$quary = "SELECT * FROM `guitar` WHERE id_vid=2 LIMIT $from, $notesOnPage";
									...
									<a class="pro-image fix" href="/guitar_details.php?id=<?=$row['g_id']?>"> <img src="<?=$row['g_photo']?>" alt="product" width="270px" height="246px"/></a>
										<!-- Product action Btn -->
										...
										<!-- Product Name -->
										<div class="pro-name">
											<a href="/guitar_details.php?id=<?=$row['g_id']?>"><?=$row['g_name']?></a>
											
												<p><span class="old"><?=$row['g_country']?></span></p>
								...
								echo '</div>';
									...
									$quary = "SELECT COUNT(*) as count FROM `guitar` WHERE id_vid=2";
									$table = mysqli_query($link, $quary);
